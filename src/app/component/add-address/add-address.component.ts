...
export class AddAddressComponent implements 

OnInit {
addressBookFormGroup: FormGroup;


City=["Anantapur","Bengaluru","Mandya","Mysore","Chennai","Chikkaballapura","Hassan","Hyderabad","Vishaakpatanam","Delhi","BBSR","Pune","Raipur","Mumbai"];
State=["Karnataka","Andra Pradesh","TamilNadu","Maharashtra","Madhya Pradesh","Odisha","Telangana","Rajasthan"];
